...
export const ALL_ITEMS: Item[] = [
  ...
  { id: 'item-voodoo-doll', name: 'Voodoo Doll', rarity: 'Legendary', image: 'https://i.ibb.co/hR8D8qP/voodoo-doll.png', imageHint: 'voodoo doll', value: 3800, description: 'A spooky voodoo doll.', isUpgradable: true, isTargetable: true },
